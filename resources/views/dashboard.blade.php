        ...
        <div class="container-fluid display-table">
            <div class="row display-table-row">
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    <div class="logo">
                        <a hef="home.html"><img src="http://jskrishna.com/work/merkury/images/logo.png" alt="Project Logo" class="hidden-xs hidden-sm">
                    ...
                    <div class="navi">
                        <ul>
                            ...
                            <li><a href="{{url('order_list')}}"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Order List</span></a></li>
                            ...
                            <li><a href="{{url('sales_report')}}"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Sales Report</span></a></li>
                            ...
                            <div class="col-md-5">
                                <div class="header-rightside">
                                    <ul class="list-inline header-top pull-right">
                                        ...
                                        <li><a href="message.html"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
                                        <li>
                                            <a href="notification.html" class="icon-info">
